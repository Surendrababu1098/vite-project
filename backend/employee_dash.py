...
POSSIBLE_GEOCACHE = [
    os.path.join(BASE_DIR, 'data', 'geocache_hyd.json'),
...
def load_json_candidates():
    ...
    candidates = {}
    # customers - prefer backend/data/customers_data.json
    cust_paths = [
        os.path.normpath(os.path.join(BASE_DIR, 'data', 'customers_data.json')),
        os.path.normpath(os.path.join(BASE_DIR, 'customers_data.json'))
    ]
    for p in cust_paths:
        if os.path.exists(p):
            try:
                ...
                continue
    # employees - prefer backend/data/employees_data.json
    emp_paths = [
        os.path.normpath(os.path.join(BASE_DIR, 'data', 'employees_data.json')),
        os.path.normpath(os.path.join(BASE_DIR, 'employees_data.json'))
    ]
    for p in emp_paths:
        if os.path.exists(p):
            try:
